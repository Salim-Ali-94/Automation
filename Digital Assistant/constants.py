...
name = "Dalia"
city = "" # the city that you currently reside in
...
elif ((hour >= 12) & (hour < 18)): greeting = "good afternoon"
elif ((hour >= 18) | (hour >= 0) & (hour < 6)): greeting = "good evening"
...
download, download_command = [torrentDownload_command[0], youtubeDownload_command[0], animeDownload_command[0]], []
