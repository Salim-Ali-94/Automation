...
class OrderFood(Downloader):
    ...
    def __init__(self, browser_path, mrDFood_admin, mrDFood_password, qbit_admin, qbit_password, mode):

        self.mrDFood_admin = mrDFood_admin
        self.mrDFood_password = mrDFood_password
        super().__init__(browser_path, qbit_admin, qbit_password, mode)
    ...
    def find_address(self):
        ...
        while not done:
            ...
            if (len(city) > 0):
                ...
                while location.rstrip().lstrip() not in super().numbers(0, len(city)):
                ...
                while not done:
                    ...
                    if (len(eateries) > 0):
                        ...
                        if (interface == "automatic"):
                            ...
                            while eatery not in super().numbers(0, len(eateries)):
                    ...
                    while (stay == True):
                        ...
                        if (interface == "manual"):
                            ...
                            while not another:
                                ...
                                while number not in super().numbers(1, len(headings)):
                                ...
                                while meal not in super().numbers(0, len(tag)):
                            ...
                            if (len(meal_card) > 1):
                                ...
                                while select.lower().rstrip().lstrip() not in super().numbers(1, len(meal_card)):
                                ...
                                for index in range(len(name_tags[address])):
                                    ...
                                    if (len(name_tags[address][index]) == 1):
                                        ...
                                        for counter in range(len(name_tags[address][index])):
                                            ...
                                            while select not in super().numbers(0, len(name_tags[address][index])):
                                        ...
                                        while select not in super().numbers(1, len(name_tags[address][index])):
                            ...
                            while not another:
                                ...
                                if (len(matches) > 1):
                                    ...
                                    while choose not in super().numbers(0, len(matches)):
                        ...
                        if (stay == False):
                            ...
                            if (len(fetch) == 0):
                                ...
                                for counter in range(len(card_heading)):
                                    ...
                                    while delete.rstrip().lstrip() not in super().numbers(0, len(card_heading)) + [""]:
